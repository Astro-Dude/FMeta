                ...
                <div className="p-4">
                  <div className="flex justify-between items-center mb-3">
                    <div className="flex space-x-4">
                      <button className={`hover:text-gray-300 transition-colors ${post.isLikedByCurrentUser ? 'text-red-500' : 'text-white'}`}>
                  ...
                  {post.likesCount > 0 && (
                    <div className="mb-2">
                      <span className="text-white font-semibold text-sm">{post.likesCount} likes</span>
                    </div>
                  )}
